...
A high-performance, lightweight web application built with **Python FastAPI** and **OAuth 2.0** that generates beautiful, dynamic vector SVG cards showing live GitHub statistics, repositories, and programming language distributions.
...
- 🌈 **6 Built-in Themes**: `midnight`, `cyberpunk`, `nord`, `dracula`, `slate`, and `light`.
...
### Supported Themes:
- `midnight` (Default dark navy / electric cyan)
- `cyberpunk` (Neon magenta / cyan glow)
- `nord` (Arctic frost dark slate)
- `dracula` (Classic vampire purple / green)
- `slate` (Minimalist neutral slate)
- `light` (Crisp clean white background)
